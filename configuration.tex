...
% Hack pour ne pas bloquer la compilation
\ifdefined\ganttalignnewline\else
\newcommand\ganttalignnewline{\todo[ligne]}
\fi
...
\newcommand\cph{Cisco IP phone 7961}
\newcommand\ata{ATA}
\newcommand\cata{Cisco ATA 186}
